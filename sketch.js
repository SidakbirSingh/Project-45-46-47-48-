...
fb=createElement("h2")
fb.html("You have passed level 1. Your score was 800!")
fb.position(100,10)
...
level2.mousePressed(()=>{
  ...
  rule3=createElement("h1")
  rule3.html("2. Please click refresh to play the level again or to play the next level.")
  rule3.position(10,90)
